 ...
 * 
 * <p>
 * This class enables a good and consistent <code>toString()</code> to be built for any class or object. This class aims
 ...
 * 
 * <p>
 * To add the superclass <code>toString</code>, use {@link #appendSuper}. To append the <code>toString</code> from an
 * object that is delegated to (or any other object), use {@link #appendToString}.
 * </p>
 * 
 * <p>
 * Alternatively, there is a method that uses reflection to determine the fields to test. Because these fields are
 * usually private, the method, <code>reflectionToString</code>, uses <code>AccessibleObject.setAccessible</code> to
...
public class ToStringBuilder implements Builder<String> {
    ...
    public ToStringBuilder appendAsObjectToString(final Object srcObject) {
        identityToString(this.getStringBuffer(), srcObject);
        return this;
    }
