...
import com.comtop.cip.common.util.tuple.Pair;
 ...
 *
 * <p>
 * This class provides methods to build a good equals method for any class. It follows rules laid out in <a
 * href="http://www.oracle.com/technetwork/java/effectivejava-136174.html">Effective Java</a> , by Joshua Bloch. In
 * particular the rule for comparing <code>doubles</code>, <code>floats</code>, and arrays can be tricky. Also, making
 * sure that <code>equals()</code> and <code>hashCode()</code> are consistent can be difficult.
 * </p>
 *
 * <p>
 * Two Objects that compare as equals must generate the same hash code, but two Objects with the same hash code do not
 * have to be equal.
 * </p>
 *
 * <p>
 * All relevant fields should be included in the calculation of equals. Derived fields may be ignored. In particular,
 * any field used in generating a hash code must be used in the equals method, and vice versa.
 * </p>
 *
 * <p>
 ...
 * usually private, the method, <code>reflectionEquals</code>, uses <code>AccessibleObject.setAccessible</code> to
...
public class EqualsBuilder implements Builder<Boolean> {
    ...
    /**
     * <p>
     * Returns <code>true</code> if the registry contains the given object pair. Used by the reflection methods to avoid
     * infinite loops. Objects might be swapped therefore a check is needed if the object pair is registered in given or
     * swapped order.
     * </p>
     *
    ...
    private static void reflectionAppend(final Object lhs, final Object rhs, final Class<?> clazz,
        final EqualsBuilder builder, final boolean useTransients, final String[] excludeFields) {
    ...
    public EqualsBuilder append(final Object lhs, final Object rhs) {
        ...
        // 当时String类型时，让""与null相等
        if ((lhs == null || lhs instanceof String) && (rhs == null || rhs instanceof String)) {
            if (StringUtil.isBlank((String) lhs) && StringUtil.isBlank((String) rhs)) {
                return this;
            }
        }
