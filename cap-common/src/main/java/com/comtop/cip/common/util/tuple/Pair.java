...
package com.comtop.cip.common.util.tuple;

import java.io.Serializable;
import java.util.Map;

import com.comtop.cip.common.util.builder.CompareToBuilder;
...
public abstract class Pair<L, R> implements Map.Entry<L, R>, Comparable<Pair<L, R>>, Serializable {
    ...
    public boolean equals(final Object obj) {
        ...
        if (obj instanceof Map.Entry<?, ?>) {
            ...
            return objectEquals(getKey(), other.getKey()) && objectEquals(getValue(), other.getValue());
        }
        return false;
    }
     ...
     * 
     * <p>
     * This uses {@link java.util.Formattable} to perform the formatting. Two variables may be used to embed the left
     * and right elements. Use {@code %1$s} for the left element (key) and {@code %2$s} for the right element (value).
     ...
     */
    private boolean objectEquals(final Object object1, final Object object2) {
        if (object1 == object2) {
            return true;
        }
