...
package com.comtop.cip.common.util.builder;
 ...
 * 
 * @since 1.0
 * @version $Id: ToStringStyle.java 1525014 2013-09-20 14:08:12Z britter $
 */
public abstract class ToStringStyle implements Serializable {
    ...
    /**
     * The default toString style. Using the Using the <code>Person</code> example from {@link ToStringBuilder}, the
    ...
    /**
     * The multi line toString style. Using the <code>Person</code> example from {@link ToStringBuilder}, the output
    ...
    /**
     * The no field names toString style. Using the Using the <code>Person</code> example from {@link ToStringBuilder},
     * the output
     * would look like this:
     * 
     * <pre>
    ...
    /**
     * The simple toString style. Using the Using the <code>Person</code> example from {@link ToStringBuilder}, the
     * output would look like this:
     * 
     * <pre>
     * John Doe,33,false
    ...
    /**
     * <p>
     * Append to the <code>toString</code> an <code>Object</code> value, printing the full <code>toString</code> of the
     ...
     * @param fullDetail <code>true</code> for detail, <code>false</code> for summary info, <code>null</code> for style
     *            decides
     */
     ...
     * 
     * <p>
     * This method performs the main lookup by Class type to correctly route arrays, <code>Collections</code>,
     * <code>Maps</code> and <code>Objects</code> to the appropriate method.
     * </p>
     * 
     * <p>
    ...
    /**
     * <p>
     * Append to the <code>toString</code> an <code>Object</code> value that has been detected to participate in a
     * cycle. This implementation will print the standard string value of the value.
     * </p>
     * 
     * @param buffer the <code>StringBuffer</code> to populate
     * @param fieldName the field name, typically not used as already appended
    ...
    /**
     * <p>
     * Append to the <code>toString</code> an <code>Object</code> value, printing the full detail of the
     * <code>Object</code>.
     * </p>
     * 
     * @param buffer the <code>StringBuffer</code> to populate
     ...
     * <code>true</code>), but a subclass might ignore that and always return <code>false</code>. The calling code may
     * pass in <code>null</code> indicating that it doesn't care about the detail level. In this case the default detail
     * level is used.
     * </p>
     * 
    ...
    private static final class MultiLineToStringStyle extends ToStringStyle {
        ...
        MultiLineToStringStyle() {
            ...
            String lineSeparator = System.getProperty("java.vm.version");
     ...
     * @param obj obj
     */
    private void identityToString(final StringBuffer buf, final Object obj) {
        if (obj == null) {
            throw new NullPointerException("Cannot get the toString of a null identity");
        }
        buf.append(obj.getClass().getName()).append('@').append(Integer.toHexString(System.identityHashCode(obj)));
    }
