 ...
 * 
 * @since 2.0
 * @version $Id: ReflectionToStringBuilder.java 1448370 2013-02-20 19:54:19Z tn $
 */
public class ReflectionToStringBuilder extends ToStringBuilder {
     ...
     * (arrays and collections). Note that {@link Arrays#sort(Object[])} will throw an {@link NullPointerException} if
     * an array element is <code>null</code>.
     * 
     * @param array
     *            The array to check
     ...
     * @since 2.1
     */
    public <T> ReflectionToStringBuilder(final T object, final ToStringStyle style, final StringBuffer buffer,
