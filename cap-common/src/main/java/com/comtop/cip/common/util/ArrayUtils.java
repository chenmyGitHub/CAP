...
import com.comtop.cip.common.util.builder.ToStringBuilder;
import com.comtop.cip.common.util.builder.ToStringStyle;
import com.comtop.cip.common.util.mutable.MutableInt;
 ...
 * 
 * @since 2.0
 * @version $Id: ArrayUtils.java 1553927 2013-12-28 21:17:57Z ggregory $
 */
public class ArrayUtils {
    ...
    /**
     * <p>
     * ArrayUtils instances should NOT be constructed in standard programming. Instead, the class should be used as
    ...
    /**
     * <p>
     * Converts the given array into a {@link java.util.Map}. Each element of the array must be either a
     * {@link java.util.Map.Entry} or an Array, containing at least two elements, where the first element is used as key
     ...
     * 
     * <p>
     * Therefore new arrays of generic types can be created with this method. For example, an array of Strings can be
     * created:
     * </p>
     * 
     * <pre>
     ...
     * 
     * <p>
     * The method is typically used in scenarios, where the caller itself uses generic types that have to be combined
     * into an array.
     * </p>
     * 
     * <p>
     * Note, this method makes only sense to provide arguments of the same type so that the compiler can deduce the type
     * of the array itself. While it is possible to select the type explicitly like in
     ...
     * 
     * <p>
     * As a memory optimizing technique an empty array passed in will be overridden with the empty {@code public static}
     ...
     * @return the index of the value within the array, {@link #INDEX_NOT_FOUND} ({@code -1}) if not found or
     *         {@code null} array input
     */
    ...
    /**
     * <p>
     * Finds the index of the given value within a given tolerance in the array. This method will return the index of
     * the first value which falls between the region defined by valueToFind - tolerance and valueToFind + tolerance.
     * </p>
     * 
     * <p>
     * This method returns {@link #INDEX_NOT_FOUND} ({@code -1}) for a {@code null} input array.
    ...
    /**
     * <p>
     * Finds the index of the given value in the array starting at the given index. This method will return the index of
     * the first value which falls between the region defined by valueToFind - tolerance and valueToFind + tolerance.
     * </p>
     * 
     * <p>
    ...
    /**
     * <p>
     * Finds the last index of the given value within a given tolerance in the array. This method will return the index
     * of the last value which falls between the region defined by valueToFind - tolerance and valueToFind + tolerance.
     * </p>
     * 
     * <p>
     * This method returns {@link #INDEX_NOT_FOUND} ({@code -1}) for a {@code null} input array.
    ...
    /**
     * <p>
     * Finds the last index of the given value in the array starting at the given index. This method will return the
     * index of the last value which falls between the region defined by valueToFind - tolerance and valueToFind +
     * tolerance.
     * </p>
     * 
     * <p>
    ...
    /**
     * <p>
     * Checks if a value falling within the given tolerance is in the given array. If the array contains a value within
     * the inclusive range defined by (value - tolerance) to (value + tolerance).
     * </p>
     * 
     * <p>
     * The method returns {@code false} if a {@code null} array is passed in.
     ...
     * 
     * <p>
     * If the input array is {@code null}, an IndexOutOfBoundsException will be thrown, because in that case no valid
     ...
     * shifted to the left (subtracts one from their indices). If the array doesn't contains such an element, no
    ...
    /**
     * <p>
     * Removes the elements at the specified positions from the specified array. All remaining elements are shifted to
     * the left.
     * </p>
     * 
     * <p>
     * This method returns a new array with the same elements of the input array except those at the specified
     * positions. The component type of the returned array is always the same as that of the input array.
     * </p>
     * 
     * <p>
     * If the input array is {@code null}, an IndexOutOfBoundsException will be thrown, because in that case no valid
    ...
    /**
     * <p>
     * Removes occurrences of specified elements, in specified quantities, from the specified array. All subsequent
     * elements are shifted left. For any element-to-be-removed specified in greater quantities than contained in the
     * original array, no change occurs beyond the removal of the existing matching items.
     * </p>
     * 
     * <p>
     * This method returns a new array with the same elements of the input array except for the earliest-encountered
     * occurrences of the specified elements. The component type of the returned array is always the same as that of the
     * input array.
     * </p>
     * 
     * <pre>
    ...
    public static boolean[] removeElements(final boolean[] array, final boolean... values) {
        ...
        final HashMap<Boolean, MutableInt> occurrences = new HashMap<Boolean, MutableInt>(2); // only two possible
                                                                                              // values here
