 ...
 */
public class MetaDataFacadeExceptionPointcut extends ProxyPointcutSupport {
    ...
    public boolean apply(MethodInfo methodInfo) {
        return isPublic(methodInfo) && isTopLevelMethod(methodInfo)
            && matchPackageName(methodInfo, "com.comtop.cip.metadata.*.facade")
            && (matchClassName(methodInfo, "*Facade") || matchClassName(methodInfo, "*FacadeImpl"));
    }
