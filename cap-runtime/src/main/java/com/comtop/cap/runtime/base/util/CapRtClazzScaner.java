...
/**
 * CAP运行时类扫描器，无任何第三方jar依赖，保障运行时jar包最小化
 * @author 李小强
 * @since 1.0
 * @version 2016-11-9 李小强
 */
public class CapRtClazzScaner {
	/** 日志 */
	private final static Logger LOG = LoggerFactory.getLogger(CapRtClazzScaner.class);
	/**
								...
								if ((idx != -1) || recursive) {
									...
									if (name.endsWith(".class")&& !entry.isDirectory()) {
										...
										try {
											...
											LOG.error("添加用户自定义类错误 找不到此类的.class文件",e);
										}
									}
								}
							}
